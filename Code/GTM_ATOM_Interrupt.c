...
/*------------------------------------------------------Macros-------------------------------------------------------*/
/*********************************************************************************************************************/
#define ISR_PRIORITY_ATOM   50                       /* Interrupt priority number                                    */
#define ATOM_FREQ           2.0f                    /* ATOM frequency                                               */
#define CMU_FREQ            20000000.0f             /* CMU clock frequency                                          */
#define LED                 &MODULE_P21, 2          /* LED which will be toggled in Interrupt Service Routine (ISR) */
...
IFX_INTERRUPT(interruptHandlerGtmAtom, 2, ISR_PRIORITY_ATOM);
...
void initGtmAtom(void)
{
    ...
    timerConfig.base.isrProvider = IfxSrc_Tos_cpu2;                             /* Set interrupt provider           */
