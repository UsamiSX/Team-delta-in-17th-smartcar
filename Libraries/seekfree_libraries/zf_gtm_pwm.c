...
void servo_init(uint32 freq, uint32 duty)
{
    IfxGtm_Atom_Pwm_Config g_atomConfig;
    IfxGtm_Atom_Pwm_Driver g_atomDriver;

    IfxGtm_Atom_ToutMap *atom_channel;
    atom_channel = &IfxGtm_ATOM2_2_TOUT20_P00_11_OUT;
...
void motor_init(uint32 freq, uint32 duty)
{
    IfxGtm_Atom_Pwm_Config g_atomConfig;
    IfxGtm_Atom_Pwm_Driver g_atomDriver;

    IfxGtm_Atom_ToutMap *atom_channel;
    atom_channel = &IfxGtm_ATOM1_7_TOUT25_P33_3_OUT;
