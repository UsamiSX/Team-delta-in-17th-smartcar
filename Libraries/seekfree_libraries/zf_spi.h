...
typedef enum    // 枚举SPI引脚
{
	...
	SPI1_MOSI_P10_1  = 1*102+1*6 , SPI1_MOSI_P10_3, SPI1_MOSI_P11_9,// SPI1_MOSI_P10_4,
	...
	SPI3_SCLK_P02_7  = 3*102+0*6 , SPI3_SCLK_P01_7, //SPI3_SCLK_P10_8,
	SPI3_MOSI_P02_6  = 3*102+1*6 , SPI3_MOSI_P01_6, SPI3_MOSI_P10_6,
	SPI3_MISO_P02_5  = 3*102+2*6 , SPI3_MISO_P01_5, //SPI3_MISO_P10_7,

	SPI3_CS0_P02_4  = 3*102+0*6 , SPI3_CS0_P33_10,
	SPI3_CS1_P02_0  = 3*102+1*6 , SPI3_CS1_P33_9,
	SPI3_CS2_P02_1  = 3*102+2*6 , SPI3_CS2_P33_8, //SPI3_CS2_P33_3,
	SPI3_CS3_P00_5  = 3*102+3*6 , SPI3_CS3_P02_2, SPI3_CS3_P22_2,
	SPI3_CS4_P00_2  = 3*102+4*6 , SPI3_CS4_P02_3, //SPI3_CS4_P23_5,
	SPI3_CS5_P02_8  = 3*102+5*6 , //SPI3_CS5_P23_4,
	SPI3_CS6_P00_8  = 3*102+6*6 , SPI3_CS6_P23_1,
	SPI3_CS7_P00_9  = 3*102+7*6 , SPI3_CS7_P02_1, SPI3_CS7_P33_7,
	SPI3_CS8_P10_5  = 3*102+8*6 ,
	//SPI3_CS9_P01_3  = 3*102+9*6 ,
	//SPI3_CS10_P01_4 = 3*102+10*6,

	SPI4_SCLK_P22_3 = 4*102 + 0*6 + 2,
	SPI4_MOSI_P22_0 = 4*102 + 1*6 + 2,
	SPI4_MISO_P22_1 = 4*102 + 2*6 + 1,

	SPI4_CS6_P23_1 = 4*102 + 9*6,
	SPI_CS_NOT_USE,
}SPI_PIN_enum;
