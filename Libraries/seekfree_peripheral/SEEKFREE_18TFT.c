...
{	
    ...
    gpio_init(BL_PIN,GPO,1,PUSHPULL);//PASS
...
void lcd_triangle(uint16 x,uint16 y)
{
    lcd_drawpoint(x,y,WHITE);
    lcd_drawpoint(x,y+1,WHITE);
    lcd_drawpoint(x,y+2,WHITE);
    lcd_drawpoint(x,y+3,WHITE);
    lcd_drawpoint(x,y+4,WHITE);
    lcd_drawpoint(x+1,y+1,WHITE);
    lcd_drawpoint(x+1,y+2,WHITE);
    lcd_drawpoint(x+1,y+3,WHITE);
    lcd_drawpoint(x+2,y+2,WHITE);
}


void lcd_triangle_b(uint16 x,uint16 y)
{
    lcd_drawpoint(x,y,BLACK);
    lcd_drawpoint(x,y+1,BLACK);
    lcd_drawpoint(x,y+2,BLACK);
    lcd_drawpoint(x,y+3,BLACK);
    lcd_drawpoint(x,y+4,BLACK);
    lcd_drawpoint(x+1,y+1,BLACK);
    lcd_drawpoint(x+1,y+2,BLACK);
    lcd_drawpoint(x+1,y+3,BLACK);
    lcd_drawpoint(x+2,y+2,BLACK);
}
