...
#define SEEKFREE_SCL    P33_7                           //定义SCL引脚  可任意更改为其他IO
#define SEEKFREE_SDA    P33_5                           //定义SDA引脚  可任意更改为其他IO
...
uint8 my_simiic_read_reg(uint8 dev_add, uint8 reg0, uint8 reg1, IIC_type type);
